...
@POST("/1/lists")
    Call<List> createList(@Query("name") String name, @Query("idBoard")  String boardId, @Query("key") String key, @Query("token") String token);

@POST("/1/cards")
    Call<Card> createCard(@Query("name") String name, @Query("idList")  String listId, @Query("key") String key, @Query("token") String token);
